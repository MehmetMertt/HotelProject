...
<html lang="de">
  ...
  <body>
    <h1>Impressum The Continental</h1>
    ...
    <section>
      <ul style="list-style-type: none">
        <li>Geschäftsführer: Mehmet Mert</li>
        <li>
          <p>
            Geschäftsanteile:<br />
            Mehmet Mert (60%)
        ...
        <li><img al="Mehmet Mert" src="img\mehmet.png" height="200px" width="auto" /></li></li>
      </ul>
      <ul style="list-style-type: none">
        <li>Florian Korcian (40%)</li>
        <li><img alt="FLorian Korcian" src="img\flo.png" height="200px" width="auto" /></li>
      </ul>
    </section>
  </body>
</html>
